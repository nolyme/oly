...
/**
 * Link component to Kernel. Since 0.13, it's not required.
 *
 ...
 * > @attach add a lot of complexity, use it with moderation.
 *
 * #### watch
 *
 * use @attach({watch: [ ...list of oly-stateNames ]} if you want to override the watch list.
 * By default this list is generated by oly.
 */
